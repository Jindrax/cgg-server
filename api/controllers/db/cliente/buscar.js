module.exports = {
  friendlyName: "Buscar cliente(s)",

  description: "Endpoint para realizar una busqueda entre los clientes del sistema",
  ...
  fn: async function (inputs, exits) {
    try{
      ...
      let consulta = await Cliente.find(inputs.consulta);
