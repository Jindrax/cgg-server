module.exports = {
  friendlyName: "Buscar cobro(s)",

  description: "Endpoint para realizar una busqueda entre los cobros del sistema",
  ...
  fn: async function (inputs, exits) {
    try{
      ...
      let consulta = await Cobro.find(inputs.consulta).populate('operario').populate('cliente');
